...
function tacticsClicked(){
    ...
    var tactics_container = document.getElementById('tactics_container');
    tactics_container.style.display = "block";
...
function uploadAttackingTactic(){
    ...
    myAttackTacticsDict[calculateNewTacticKey(myAttackTacticsDict)] = tacticName;
...
function uploadDefendingTactic(){
    ...
    myDefendTacticsDict[calculateNewTacticKey(myDefendTacticsDict)] = tacticName;
...
function replaceTacticSubmit(){
    ...
    if (oldTacticNameTmp.includes("attacking")){
        ...
        myAttackTacticsDict[getKeyByValue(myAttackTacticsDict, oldTacticName)] = newTacticName;
        ...
        myDefendTacticsDict[getKeyByValue(myDefendTacticsDict, oldTacticName)] = newTacticName;
...
function confirmDeleteTactic(){
    ...
    if (tactic2deleteTmp.includes("attacking")){
        ...
        delete myAttackTacticsDict[getKeyByValue(myAttackTacticsDict, tactic2delete)];
        deleteTacticFromUI('attacking', tactic2delete);
    } else {
        tactic2delete = tactic2deleteTmp.replace("My defending tactic: ", "");    
        delete myDefendTacticsDict[getKeyByValue(myDefendTacticsDict, tactic2delete)];
...
function invitationAccepted(opponent){
    ...
    var play_text = document.getElementById('play_text_id');
    play_text.innerText = opponent + ' accepted your invitation. Press Play to begin the game. '
...
function acceptInvitation(){
    userStatus.accept().then(()=>{
        ...
        localStorage.setItem('myAttackTacticsDict', JSON.stringify(myAttackTacticsDict));
        localStorage.setItem('myDefendTacticsDict', JSON.stringify(myDefendTacticsDict));
